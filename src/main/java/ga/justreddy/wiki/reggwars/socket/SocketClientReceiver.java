            ...
            case GAME_LEAVE: {
                ...
                if (player != null) {
                    GameManager.getManager().getGameByName(playerPacket.getGame().getName())
                            .onGamePlayerQuit(PlayerManager.getManager().getGamePlayer(player.getUniqueId()), true);
                }
                break;
            }
            case GAMES_ADD: {
            ...
            case KICK: {
                ...
                if (player != null) {
                    ...
                    GameManager.getManager().getGameByName(kickPacket.getGame().getName())
                            .onGamePlayerQuit(PlayerManager.getManager().getGamePlayer(player.getUniqueId()), false);
                }
            }
            case GAMES_SEND: {
