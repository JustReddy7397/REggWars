...
public class FastBoard {
    ...
    static {
        try {
            ...
            } else if (FastReflection.nmsOptionalClass(null, "ScoreboardServer$AbstractAction").isPresent()) {
            ...
            if (VersionType.V1_8.isHigherOrEqual()) {
                String enumSbActionClass = VersionType.V1_13.isHigherOrEqual()
                        ? "ScoreboardServer$AbstractAction"
    ...
    private void sendScorePacket(int score, ScoreboardAction action) throws Throwable {
        ...
        if (VersionType.V1_8.isHigherOrEqual()) {
            ...
            setField(packet, int.class, action.ordinal(), 1); // AbstractAction
        }
