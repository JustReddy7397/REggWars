...
import ga.justreddy.wiki.reggwars.model.game.items.SheerItem;
import ga.justreddy.wiki.reggwars.model.game.items.UpgradableAxeItem;
import ga.justreddy.wiki.reggwars.model.game.items.UpgradablePickaxeItem;
...
public class ShopManager {
    ...
    public ShopManager() {
        ...
        registerCustomShopItem(new UpgradableAxeItem());
        registerCustomShopItem(new UpgradablePickaxeItem());
        registerCustomShopItem(new SheerItem());
