        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (player != null && Bukkit.getOnlinePlayers().contains(player)) {
                    /*if (REggWars.getInstance().getMessenger().isDebug()) {
                        REggWars.getInstance().getMessenger().log(Level.INFO, "[X] Player " + player.getName() + " joined game " + game.getName() + " successfully!");
                    }*/
